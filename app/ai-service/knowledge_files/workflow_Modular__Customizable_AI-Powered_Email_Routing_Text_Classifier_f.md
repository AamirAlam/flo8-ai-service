...
**[View Template](https://n8n.io/workflows/2851-/)**  **Published Date:** 02/05/2025  **Created By:** Davide  **Categories:** `Communication` `Core Nodes` `HITL` `Data & Storage` `Productivity` `AI` `Langchain`  
