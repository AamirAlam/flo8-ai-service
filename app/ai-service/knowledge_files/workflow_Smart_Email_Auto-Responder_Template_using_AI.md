...
**[View Template](https://n8n.io/workflows/3277-/)**  **Published Date:** 03/21/2025  **Created By:** Amjid Ali  **Categories:** `Communication` `Core Nodes` `HITL` `Marketing` `AI` `Langchain`  
