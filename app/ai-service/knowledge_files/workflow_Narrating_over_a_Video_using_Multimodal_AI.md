...
**[View Template](https://n8n.io/workflows/2467-/)**  **Published Date:** 10/17/2024  **Created By:** Jimleuk  **Categories:** `Core Nodes` `Marketing` `Development` `Data & Storage` `AI` `Langchain`  
