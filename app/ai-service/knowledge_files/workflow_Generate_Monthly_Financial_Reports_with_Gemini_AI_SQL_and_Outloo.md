...
**[View Template](https://n8n.io/workflows/3617-/)**  **Published Date:** 04/19/2025  **Created By:** Amjid Ali  **Categories:** `Data & Storage` `Development` `Communication` `HITL` `Core Nodes` `AI` `Langchain`  
