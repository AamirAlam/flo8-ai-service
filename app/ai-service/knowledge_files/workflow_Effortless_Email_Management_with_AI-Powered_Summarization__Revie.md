...
**[View Template](https://n8n.io/workflows/2862-/)**  **Published Date:** 02/07/2025  **Created By:** Davide  **Categories:** `Communication` `Core Nodes` `HITL` `Development` `Data & Storage` `AI` `Langchain`  
