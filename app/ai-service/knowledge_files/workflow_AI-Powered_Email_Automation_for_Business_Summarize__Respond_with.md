...
**[View Template](https://n8n.io/workflows/2852-/)**  **Published Date:** 02/05/2025  **Created By:** Davide  **Categories:** `Communication` `Core Nodes` `HITL` `Development` `Data & Storage` `AI` `Langchain`  
