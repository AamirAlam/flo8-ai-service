...
**[View Template](https://n8n.io/workflows/2369-/)**  **Published Date:** 07/29/2024  **Created By:** Łukasz  **Categories:** `Communication` `Core Nodes` `HITL` `Data & Storage` `Development`  
