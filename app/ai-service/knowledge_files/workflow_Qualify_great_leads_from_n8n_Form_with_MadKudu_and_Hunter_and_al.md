...
**[View Template](https://n8n.io/workflows/2119-/)**  **Published Date:** 02/22/2024  **Created By:** Mutasem  **Categories:** `Development` `Core Nodes` `Communication` `HITL` `Sales`  
...
How to setup
Add you MadKudu, Hunter, and Slack credentials 
