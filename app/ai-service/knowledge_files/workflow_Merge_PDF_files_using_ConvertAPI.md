...
**[View Template](https://n8n.io/workflows/2298-/)**  **Published Date:** 06/25/2024  **Created By:** ConvertAPI  **Categories:** `Development` `Core Nodes`  
...
Open the PDF merge HTTP Request node.
