...
**[View Template](https://n8n.io/workflows/2800-/)**  **Published Date:** 01/25/2025  **Created By:** Friedemann Schuetz  **Categories:** `Communication` `Core Nodes` `HITL` `Development` `Productivity` `AI` `Langchain`  
