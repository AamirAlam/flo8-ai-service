...
**[View Template](https://n8n.io/workflows/2571-/)**  **Published Date:** 11/25/2024  **Created By:** Nukeador  **Categories:** `Development` `Core Nodes`  
...
You'll need to generate a BlueSky app password
Configure your feed URL in the first node
Configure your credentials in the second node
