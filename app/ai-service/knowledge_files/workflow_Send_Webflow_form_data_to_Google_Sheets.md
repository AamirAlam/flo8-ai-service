...
**[View Template](https://n8n.io/workflows/2555-/)**  **Published Date:** 11/17/2024  **Created By:** Giovanni Ruggieri  **Categories:** `Data & Storage` `Productivity` `Development` `Core Nodes`  
...
Form Submitted 🎉 – A Webflow form submission triggers the flow.  
Fields Prepared 🛠️ – Data gets organized, and a submission date is added.  
Data Logged 📋 – Your data finds a cozy new home in Google Sheets.  

Set-Up Steps  
⏱️ Estimated Time: 5-10 minutes  
Connect Webflow 🌐 – Hook up your Webflow account and disable legacy APIs (instructions inside the workflow).  
Set Up Google Sheets 🧾 – Choose your spreadsheet and authenticate.  
You're Ready! 💫 – Let the workflow take it from here.  
