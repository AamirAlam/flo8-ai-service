...
**[View Template](https://n8n.io/workflows/3595-/)**  **Published Date:** 04/17/2025  **Created By:** RealSimple Solutions  **Categories:** `Communication` `HITL` `Development` `Core Nodes` `AI` `Langchain`  
