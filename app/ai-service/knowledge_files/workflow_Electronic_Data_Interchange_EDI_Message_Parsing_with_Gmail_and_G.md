...
**[View Template](https://n8n.io/workflows/3221-/)**  **Published Date:** 03/19/2025  **Created By:** Samir Saci  **Categories:** `Data & Storage` `Productivity` `Communication` `HITL` `Development` `Core Nodes`  
...
📧 Gmail Trigger → Detects emails with "EDI" in the subject.
📜 Parses EDI Message → Uses a JavaScript Code Node to extract structured data.
📊 Formats the Data → Converts it into a table-friendly format.
📑 Updates Google Sheets → Automatically logs the processed orders.
...
If you want to learn more about Electronic Data Interchange: 🚚 Blog Article about Electronic Data Interchange (EDI)
