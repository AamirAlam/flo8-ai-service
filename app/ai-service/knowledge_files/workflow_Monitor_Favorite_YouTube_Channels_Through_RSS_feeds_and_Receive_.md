...
**[View Template](https://n8n.io/workflows/3003-/)**  **Published Date:** 02/24/2025  **Created By:** Joseph LePage  **Categories:** `Development` `Core Nodes` `Communication` `HITL` `AI` `Langchain`  
