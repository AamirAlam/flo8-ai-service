...
**[View Template](https://n8n.io/workflows/2165-/)**  **Published Date:** 03/05/2024  **Created By:** David Roberts  **Categories:** `Data & Storage` `Development` `Core Nodes` `AI` `Langchain`  
