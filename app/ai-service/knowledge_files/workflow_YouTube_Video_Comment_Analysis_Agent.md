...
**[View Template](https://n8n.io/workflows/2965-/)**  **Published Date:** 02/21/2025  **Created By:** Joseph LePage  **Categories:** `Development` `Core Nodes` `Data & Storage` `Communication` `HITL` `AI` `Langchain`  
