...
**[View Template](https://n8n.io/workflows/3195-/)**  **Published Date:** 03/17/2025  **Created By:** Samir Saci  **Categories:** `Data & Storage` `Productivity` `Development` `Core Nodes` `Utility` `AI` `Langchain`  
