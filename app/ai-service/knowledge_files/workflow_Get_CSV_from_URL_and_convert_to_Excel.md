...
**[View Template](https://n8n.io/workflows/2041-/)**  **Published Date:** 01/07/2024  **Created By:** Yulia  **Categories:** `Development` `Core Nodes`  
...
N.B. Note that as of version 1.23.0 n8n, the Spreadsheet File node has been redesigned and is now called Convert to File node. Learn more on the release notes page: https://docs.n8n.io/release-notes/#n8n1230
