...
**[View Template](https://n8n.io/workflows/2015-/)**  **Published Date:** 12/12/2023  **Created By:** Corentin Ribeyre  **Categories:** `Data & Storage` `Productivity` `Development` `Core Nodes`  
...
This workflow can be divided into four steps :
    ...
    It performs an HTTP request to scan the domains/companies.

Set up steps
    You will need a formated Google sheet file with company/domain names. 
    You will need a working icypeas account to run the workflow and get your API Key, API Secret and User ID.
    You will need domain/companies names to scan them.
