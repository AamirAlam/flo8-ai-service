...
**[View Template](https://n8n.io/workflows/2121-/)**  **Published Date:** 02/22/2024  **Created By:** Mutasem  **Categories:** `Development` `Core Nodes` `Communication` `HITL` `Sales`  
...
How to setup
Add you MadKudu, Hunter, and Telegram credentials 
Set the Telegram chat id to send to
Click the Test Workflow button, enter your email and check your email
