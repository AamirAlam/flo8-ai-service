...
**[View Template](https://n8n.io/workflows/2312-/)**  **Published Date:** 07/04/2024  **Created By:** bartv  **Categories:** `Communication` `HITL` `Development` `Core Nodes`  
...
Update the Gmail note with your own email address, or replace it with any other notification mechanism. You can also use Slack, Discord, Telegram or text messages.. 
