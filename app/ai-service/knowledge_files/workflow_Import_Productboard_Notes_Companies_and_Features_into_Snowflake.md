...
**[View Template](https://n8n.io/workflows/2576-/)**  **Published Date:** 11/25/2024  **Created By:** Romain Jouhannet  **Categories:** `Development` `Core Nodes` `Communication` `HITL` `Data & Storage`  
