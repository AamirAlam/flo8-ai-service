...
**[View Template](https://n8n.io/workflows/1747-joining-different-datasets/)**  
**Published Date:** 03/20/2023  
**Created By:** Jonathan  
**Categories:** `Engineering`, `Building Blocks`  
...
## **Why?**
One of the powerful capabilities of n8n is the ability to **branch out a workflow** to process different datasets. Even more powerful is the ability to **join them back together** using SQL-like joining logic.

---

## **Main Use Cases**
- **Appending datasets** – Combine two datasets into a single output.
- **Keep only new items** – Retain only the newly added data.
- **Keep only existing items** – Filter to maintain only the items that already exist.

---

This workflow demonstrates **data merging and filtering** capabilities in n8n, making it a great tool for handling **structured data operations** efficiently.
