...
**[View Template](https://n8n.io/workflows/2326-/)**  **Published Date:** 07/10/2024  **Created By:** Jimleuk  **Categories:** `Communication` `HITL` `Productivity` `Development` `Core Nodes` `AI` `Langchain`  
