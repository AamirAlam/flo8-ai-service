...
**[View Template](https://n8n.io/workflows/1425-/)**  **Published Date:** 02/03/2022  **Created By:** Hilary Torn  **Categories:** `Data & Storage` `Development` `Core Nodes` `Communication` `HITL`  
