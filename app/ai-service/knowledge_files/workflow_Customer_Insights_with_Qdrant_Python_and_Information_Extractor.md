...
**[View Template](https://n8n.io/workflows/2373-/)**  **Published Date:** 08/05/2024  **Created By:** Jimleuk  **Categories:** `Data & Storage` `Productivity` `Development` `Core Nodes` `AI` `Langchain`  
