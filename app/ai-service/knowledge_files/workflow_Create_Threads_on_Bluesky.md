...
**[View Template](https://n8n.io/workflows/2798-/)**  **Published Date:** 01/25/2025  **Created By:** Gareth B. Davies  **Categories:** `Development` `Core Nodes`  
...
Customize the post text in the Code nodes to match your content:
   Initial visible post
   Hidden reply posts
   Final visible posts
Adjust the scheduling in the "Run Daily at 9 AM" node to match your preferred posting time
