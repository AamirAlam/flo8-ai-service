...
**[View Template](https://n8n.io/workflows/3350-/)**  **Published Date:** 03/29/2025  **Created By:** Jimleuk  **Categories:** `Data & Storage` `Development` `Communication` `HITL` `Core Nodes` `AI` `Langchain`  
