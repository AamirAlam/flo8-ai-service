...
**[View Template](https://n8n.io/workflows/3510-/)**  **Published Date:** 04/10/2025  **Created By:** Davide  **Categories:** `Data & Storage` `Productivity` `Communication` `HITL` `Sales` `Development` `Core Nodes` `AI` `Langchain`  
