...
**[View Template](https://n8n.io/workflows/2161-/)**  **Published Date:** 03/05/2024  **Created By:** Jan Oberhauser  **Categories:** `Development` `Core Nodes` `Sales` `Miscellaneous` `AI` `Langchain`  
