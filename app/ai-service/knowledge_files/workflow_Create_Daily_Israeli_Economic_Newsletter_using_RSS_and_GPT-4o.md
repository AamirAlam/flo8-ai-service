...
**[View Template](https://n8n.io/workflows/3564-/)**  **Published Date:** 04/15/2025  **Created By:** Elay Guez  **Categories:** `Communication` `Core Nodes` `HITL` `Development` `AI` `Langchain`  
