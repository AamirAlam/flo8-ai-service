...
**[View Template](https://n8n.io/workflows/2377-/)**  **Published Date:** 08/12/2024  **Created By:** Mario  **Categories:** `Data & Storage` `Development` `Core Nodes` `Communication` `HITL` `AI` `Langchain`  
