...
**[View Template](https://n8n.io/workflows/2697-/)**  **Published Date:** 01/05/2025  **Created By:** ibrhdotme  **Categories:** `Communication` `Core Nodes` `HITL` `Development` `Marketing` `AI` `Langchain`  
