...
**[View Template](https://n8n.io/workflows/3445-/)**  **Published Date:** 04/06/2025  **Created By:** Imperol  **Categories:** `Development` `Core Nodes`  
...
Set your n8n login details on the node set Credentials with the n8n URL, username, and password.
Setup your n8n API credentials on the n8n node get workflows
Run the workflow. This opens up a form where you can select the number of tags to move and click on submit
The workflow responds with the successful number of workflows that were imported 
