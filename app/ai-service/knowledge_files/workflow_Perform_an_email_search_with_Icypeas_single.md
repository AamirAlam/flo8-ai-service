...
**[View Template](https://n8n.io/workflows/2013-/)**  **Published Date:** 12/11/2023  **Created By:** Corentin Ribeyre  **Categories:** `Development` `Core Nodes`  

## Template Description

This template can be used to search for an email address with Icypeas. Be sure to have an active account to use this template. 
...
It performs an HTTP request to search for an email address.

Set up steps
You will need a working icypeas account to run the workflow and get your API Key, API Secret and User ID.
You will need a personn firstname, lastname and domain/company name to perform the search.
