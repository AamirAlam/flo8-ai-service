...
**[View Template](https://n8n.io/workflows/2899-/)**  **Published Date:** 02/13/2025  **Created By:** Davide  **Categories:** `Communication` `Core Nodes` `HITL` `Data & Storage` `Productivity` `Development`  
