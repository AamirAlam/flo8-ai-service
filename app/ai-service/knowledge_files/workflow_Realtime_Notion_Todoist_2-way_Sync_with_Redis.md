...
**[View Template](https://n8n.io/workflows/2772-/)**  **Published Date:** 01/21/2025  **Created By:** Mario  **Categories:** `Development` `Core Nodes` `Data & Storage` `Productivity` `Communication` `HITL`  
