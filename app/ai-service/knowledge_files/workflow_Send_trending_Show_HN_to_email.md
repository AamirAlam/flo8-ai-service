...
**[View Template](https://n8n.io/workflows/225-/)**  **Published Date:** 01/01/2020  **Created By:** Jan Oberhauser  **Categories:** `Communication` `Core Nodes` `HITL` `Development`  
...
Combines the items into a simple email text
Sends an email with the email text
