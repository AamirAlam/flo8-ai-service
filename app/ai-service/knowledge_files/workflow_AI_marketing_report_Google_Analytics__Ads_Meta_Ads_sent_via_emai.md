...
**[View Template](https://n8n.io/workflows/2783-/)**  **Published Date:** 01/23/2025  **Created By:** Friedemann Schuetz  **Categories:** `Communication` `Core Nodes` `HITL` `Development` `Analytics` `AI` `Langchain`  
