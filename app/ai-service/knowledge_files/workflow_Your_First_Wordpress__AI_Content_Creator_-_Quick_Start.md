...
**[View Template](https://n8n.io/workflows/2981-/)**  **Published Date:** 02/23/2025  **Created By:** Joseph LePage  **Categories:** `Development` `Core Nodes` `Communication` `HITL` `Data & Storage` `Marketing` `AI` `Langchain`  
