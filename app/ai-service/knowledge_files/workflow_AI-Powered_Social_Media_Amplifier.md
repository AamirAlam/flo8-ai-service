...
**[View Template](https://n8n.io/workflows/2681-/)**  **Published Date:** 12/29/2024  **Created By:** Mudit Juneja  **Categories:** `Data & Storage` `Development` `Core Nodes` `Communication` `HITL` `Marketing` `AI` `Langchain`  
