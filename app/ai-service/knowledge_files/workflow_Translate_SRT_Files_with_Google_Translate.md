...
**[View Template](https://n8n.io/workflows/3620-/)**  **Published Date:** 04/20/2025  **Created By:** DanielV  **Categories:** `Utility` `Development` `Core Nodes`  
    ...
    "Receive SRT File to Translate": [
      {
        "json": {
          ...
          "Upload SRT file": {
            "size": 7748,
            "filename": "Morran och Tobias 15.srt",
