...
**[View Template](https://n8n.io/workflows/3010-/)**  **Published Date:** 02/25/2025  **Created By:** Joseph LePage  **Categories:** `Development` `Core Nodes` `Communication` `HITL` `Marketing` `AI` `Langchain`  
