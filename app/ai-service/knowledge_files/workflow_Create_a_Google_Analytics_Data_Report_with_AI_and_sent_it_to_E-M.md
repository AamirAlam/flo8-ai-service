...
**[View Template](https://n8n.io/workflows/2673-/)**  **Published Date:** 12/25/2024  **Created By:** Friedemann Schuetz  **Categories:** `Communication` `Core Nodes` `HITL` `Analytics` `Development` `AI` `Langchain`  
