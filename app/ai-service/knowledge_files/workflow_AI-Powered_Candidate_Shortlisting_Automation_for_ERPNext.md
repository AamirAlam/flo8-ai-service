...
**[View Template](https://n8n.io/workflows/2757-/)**  **Published Date:** 01/20/2025  **Created By:** Amjid Ali  **Categories:** `Development` `Core Nodes` `Communication` `HITL` `Data & Storage` `Finance & Accounting` `AI` `Langchain`  
