...
**[View Template](https://n8n.io/workflows/2124-/)**  **Published Date:** 02/23/2024  **Created By:** Milorad Filipović  **Categories:** `Development` `Core Nodes` `Sales` `Productivity` `Communication` `HITL`  
