...
**[View Template](https://n8n.io/workflows/2803-/)**  **Published Date:** 01/26/2025  **Created By:** mustafa kendigüzel  **Categories:** `Development` `Core Nodes` `Data & Storage` `Communication` `HITL` `AI` `Langchain`  
