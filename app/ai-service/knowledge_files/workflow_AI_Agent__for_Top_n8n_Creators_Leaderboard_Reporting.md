...
**[View Template](https://n8n.io/workflows/2942-/)**  **Published Date:** 02/19/2025  **Created By:** Joseph LePage  **Categories:** `Development` `Core Nodes` `Communication` `HITL` `Data & Storage` `AI` `Langchain`  
