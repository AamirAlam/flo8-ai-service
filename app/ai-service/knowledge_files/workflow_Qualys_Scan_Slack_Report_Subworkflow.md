...
**[View Template](https://n8n.io/workflows/2512-/)**  **Published Date:** 10/31/2024  **Created By:** Angel Menendez  **Categories:** `Development` `Core Nodes` `Communication` `HITL`  
...
Ensure your Slack and Qualys integrations are properly set up.
Customize the workflow to fit your specific reporting needs.
Link to parent workflow
Link to Vulnerability Scan Trigger
