...
**[View Template](https://n8n.io/workflows/2550-/)**  **Published Date:** 11/15/2024  **Created By:** Marcel Claus-Ahrens  **Categories:** `Communication` `Core Nodes` `HITL` `Data & Storage` `Productivity` `Development`  
