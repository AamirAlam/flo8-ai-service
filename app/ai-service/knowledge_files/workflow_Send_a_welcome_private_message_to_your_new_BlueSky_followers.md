...
**[View Template](https://n8n.io/workflows/2570-/)**  **Published Date:** 11/25/2024  **Created By:** Nukeador  **Categories:** `Development` `Core Nodes`  
...
Fill your credentials and the message text on the corresponding nodes (see sticky notes).
...
You can leave comments, feedback or improvements about this workflow on the n8n forums
