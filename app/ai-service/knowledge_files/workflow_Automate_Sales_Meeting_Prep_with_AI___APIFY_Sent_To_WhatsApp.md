...
**[View Template](https://n8n.io/workflows/2582-/)**  **Published Date:** 11/26/2024  **Created By:** Jimleuk  **Categories:** `Development` `Core Nodes` `Productivity` `Communication` `HITL` `AI` `Langchain`  
