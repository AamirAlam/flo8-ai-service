...
**[View Template](https://n8n.io/workflows/2633-/)**  **Published Date:** 12/11/2024  **Created By:** Johan Denoyer  **Categories:** `Development` `Core Nodes` `Sales` `Marketing`  
...
Setup steps 
Add your AgileCRM credentials
Add your INSEE OpenData credentials
Add two company custom fields in your Agile CRM (for SIREN data and ReadOnly support)
