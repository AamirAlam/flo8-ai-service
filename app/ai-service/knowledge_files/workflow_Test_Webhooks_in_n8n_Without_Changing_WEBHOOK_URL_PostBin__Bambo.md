...
**[View Template](https://n8n.io/workflows/2869-/)**  **Published Date:** 02/08/2025  **Created By:** Ludwig  **Categories:** `Development` `Core Nodes` `Communication` `HITL` `Miscellaneous` `Data & Storage` `AI` `Langchain`  
