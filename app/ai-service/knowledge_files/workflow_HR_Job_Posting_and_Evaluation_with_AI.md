...
**[View Template](https://n8n.io/workflows/2773-/)**  **Published Date:** 01/22/2025  **Created By:** Francis Njenga  **Categories:** `Data & Storage` `Communication` `Core Nodes` `HITL` `AI` `Langchain`  
